...
if CLIENT then
   SWEP.PrintName          = "Disguised Crowbar"
   SWEP.Slot               = 6
   -- flipped and wide view to ensure the user knows he has a whacky gun equipped
   SWEP.ViewModelFlip      = true
   SWEP.ViewModelFOV       = 90

   SWEP.EquipMenuData = {
      type = "item_weapon",
      desc = "A shotgun\nDisguised like a Crowbar.\nLooks like a shotgun to you,\nbut a crowbar to everyone else."
   };

   SWEP.Icon               = "vgui/ttt/icon_legendary_disgcrowbar"
...
SWEP.Primary.Delay         = 0.96
SWEP.Primary.ClipSize      = 2
SWEP.Primary.ClipMax       = 0
SWEP.Primary.DefaultClip   = 2
SWEP.Primary.Automatic     = true
SWEP.Primary.NumShots      = 8
SWEP.Primary.Sound         = Sound( "weapons/shotgun/shotgun_fire6.wav" ) -- hl2 shotgun sound
...
SWEP.UseHands              = true
SWEP.ViewModel             = "models/weapons/c_shotgun.mdl" --hl2 shotgun viewmodel
